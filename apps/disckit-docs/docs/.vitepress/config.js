...
export default defineConfig({
  ...
  themeConfig: {
    ...
    // ── Top nav — same pattern as discord.js ─────────────────────────────────
    nav: [
      { text: 'Docs',    link: '/packages/common' },
      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Contributing',  link: '/guide/contributing', badge: { text: 'Soon', type: 'warning' } },
          ],
        },
      ],
      '/packages/': [
    ...
    footer: {
      ...
      copyright: 'Copyright © 2025–present disckit',
    },
