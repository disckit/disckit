...
<package>/
  src/          ← main logic
  tests/run.js  ← node --test tests/run.js (0 failures required)
...
3. Add it to the sidebar in `apps/disckit-docs/docs/.vitepress/config.js`
...
Publish from the dashboard root:
