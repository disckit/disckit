...
| [`@disckit/embed`](./embed) | [![npm](https://img.shields.io/npm/v/@disckit/embed.svg?style=flat-square&color=5865F2)](https://www.npmjs.com/package/@disckit/embed) | Fluent Discord embed builder with presets and pagination — no discord.js required |
...
| [`@disckit/paginator`](./paginator) | [![npm](https://img.shields.io/npm/v/@disckit/paginator.svg?style=flat-square&color=5865F2)](https://www.npmjs.com/package/@disckit/paginator) | Universal pagination — buttons, select menus, page window, per-user `PaginatorStore` |
