...
//   const { X } = require("@disckit/antiflood");   // CommonJS
//   import { X } from "@disckit/antiflood";         // ESM (Node >=18, bundlers)
//
...
export declare class AntifloodManager {
  ...
  stats(): { hits: number; blocked: number; whitelisted: number; ratio: number };
  resetStats(): void;
}
